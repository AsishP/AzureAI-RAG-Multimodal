...
AI_SEARCH_SERVICE_ENDPOINT = os.getenv("AZURE_SEARCH_ENDPOINT_2")
AZURE_SEARCH_ADMIN_KEY = os.getenv("AZURE_SEARCHKEY_2")
AI_SEARCH_INDEX_NAME = os.getenv("AZURE_SEARCH_INDEX_2")
